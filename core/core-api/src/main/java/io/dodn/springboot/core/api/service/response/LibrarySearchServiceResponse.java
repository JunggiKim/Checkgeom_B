...
public record LibrarySearchServiceResponse(List<LibrarySearchServiceResponse.BookDto> bookDtoList, int bookSearchTotalCount , List<String> moreViewLink , String libraryTypeText) {

    public static LibrarySearchServiceResponse of(List<LibrarySearchServiceResponse.BookDto> bookList, int bookSearchTotalCount , List<String> moreViewLink , String libraryTypeText) {
