...
public class GyeonggiDoCyberLibrary {
    ...
    public static String seeMoreSearchUrlCreate(String searchType, String searchText,
            GyeonggiDoCyberLibraryBookType gyeonggiDoCyberLibraryBookType, String searchSize) {
        return basicSearchURL + "keyword=" + searchText + "&searchType=" + searchType + "&listType=" + "list" + "&sort="
                + "publishDate" + "&contentType=" + gyeonggiDoCyberLibraryBookType.getType() + "&asc=" + "desc"
                + "&size=" + searchSize;
