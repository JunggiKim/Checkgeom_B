...
public record GyeonggiDoCyberLibraryServiceResponse(List<BookDto> bookDtoList, int totalCount) {

    public static GyeonggiDoCyberLibraryServiceResponse of(List<BookDto> bookDtoList, int totalCount) {

        return new GyeonggiDoCyberLibraryServiceResponse(bookDtoList, totalCount);
    }
