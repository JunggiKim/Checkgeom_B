...
public class LibraryService {
    ...
    public LibraryService(GyeonggiDoCyberLibraryRepository gyeonggiDoCyberLibraryRepository) {
    ...
    public GyeonggiDoCyberLibraryServiceResponse search(SearchServiceRequest searchRequest
        ...
        List<GyeonggiDoCyberLibraryServiceResponse.BookDto> bookDtoList = gyeonggiDoCyberLibraryRepository
            .getGyeonggiDoCyberLibraryResponse(webDriver.getPageSource())
            .stream()
        ...
        return GyeonggiDoCyberLibraryServiceResponse.of(bookDtoList, bookDtoList.size());
    ...
    private ChromeDriver openWebBrowser(SearchServiceRequest searchRequest) {
        ...
        log.info("기본 url = {}", basicSearchUrl);
